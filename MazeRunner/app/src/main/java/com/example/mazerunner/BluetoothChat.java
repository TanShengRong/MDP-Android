...
//                mySocket.getRemoteDevice().getAddress();
                Log.d(TAG ,mySocket.getRemoteDevice().getAddress());

                // Broadcast Connection Message
                Intent connectionStatusIntent = new Intent("btConnectionStatus");
                connectionStatusIntent.putExtra("ConnectionStatus", "Disconnected");
    ...
    */
    public static boolean writeMsg(byte[] out) {
